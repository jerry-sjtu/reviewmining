...
public class MongoDB {
	...
	static {
		...
		try {
			System.out.println("start to set up mongo");
			String path = Const.MONGO_CONFIG_FILE;
			System.out.println(path);
			InputStream in = new FileInputStream(path);
			properties.load(in);
			mongoAddresStr = properties.getProperty(Const.MONGO_ADDRESSSTR_PROPERTY) ;
			System.out.println(mongoAddresStr);
			assert mongoAddresStr != null && !mongoAddresStr.trim().isEmpty() : "mongoAddresStr is null";
			
			mongoDBStr = properties.getProperty(Const.MONGO_DBSTR_PROPERTY);
			System.out.println(mongoDBStr);
			
			assert mongoDBStr != null && !mongoDBStr.trim().isEmpty() : "mongoDBStr is null";
			
			mongoCollectionStr = properties.getProperty(Const.MONGO_COLLECTIONSTR_PROPERTY);
			System.out.println(mongoCollectionStr);
		...
		//Summarizer.summarzierSingle =  new Summarizer("food");
	}
